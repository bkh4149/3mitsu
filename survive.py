...
class Game():
    def __init__(self):
        ...
        self.isQkey = False
        self.isWin = False
        #self.level_dict = {"sec":{1:10, 2:15, 3:20, 4:20, 5:20}, "hp":{1:40, 2:75, 3:120, 4:160, 5:200}, "teki":{1:10, 2:20, 3:26, 4:32, 5:40}}#test
        #self.level_dict = {"sec":{1:30, 2:55, 3:70, 4:90, 5:110}, "hp":{1:40, 2:75, 3:120, 4:160, 5:200}, "teki":{1:10, 2:20, 3:26, 4:32, 5:40}}
        self.level_dict = {"sec":{1:30, 2:55, 3:70, 4:90, 5:110}, "hp":{1:3, 2:10, 3:20, 4:35, 5:50}, "teki":{1:10, 2:20, 3:26, 4:32, 5:40}}#本番
        self.level = 1
